...
const PaymentInformation = () => {
  ...
  const getFieldLabel = (key) => {
    const labels = {
      ...
      cvv: '3-Digit CVV',
      expMonth: 'Expiry Date Month',
      expYear: 'Expiry Date Year',
              ...
              <Paper sx={{ 
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <DetailItem
                      label="Expiry Month"
                      value={paymentInfo.expMonth ? String(paymentInfo.expMonth).padStart(2, '0') : "N/A"}
              ...
              <Grid item xs={12} sm={key === 'creditCardNumber' ? 12 : 6} md={key === 'creditCardNumber' ? 8 : 4} key={key}>
                <TextField
                  ...
                  InputProps={{
                    ...
                    endAdornment: (key === 'creditCardNumber' || key === 'cvv') ? (
                      <InputAdornment position="end">
                        <IconButton
                          onClick={() => {
                            if (key === 'creditCardNumber') setShowCreditCardNumber(!showCreditCardNumber);
                            if (key === 'cvv') setShowCVV(!showCVV);
                          }}
                          edge="end"
                        >
                          {((key === 'creditCardNumber' && showCreditCardNumber) ||
                            (key === 'cvv' && showCVV)) ? <VisibilityOffIcon /> : <VisibilityIcon />}
                        </IconButton>
                      </InputAdornment>
                    ) : undefined
                  }}
                  type={(key === 'creditCardNumber' && !showCreditCardNumber) || (key === 'cvv' && !showCVV) ? 'password' : 'text'}
                  inputProps={{
                ...
                {key === 'accountType' ? (
                  ...
                  <TextField
                    ...
                    InputProps={{
                      ...
                      endAdornment: key === 'accountNumber' ? (
                        <InputAdornment position="end">
                          <IconButton
                    ...
                    type={key === 'accountNumber' && !showAccountNumber ? 'password' : 'text'}
                    inputProps={{
                      inputMode: key !== "accountName" && key !== "accountType" ? "numeric" : "text",
