...
const CompanyDetails = () => {
  ...
  const handleSave = () => {
    // If your API wants contact details saved elsewhere, keep this UI save to company info only.
    // For now we pass the merged object; your backend can ignore unknown keys safely.
      ...
      {isEditMode ? (
        fieldInfo.type === "select" ? (
          <TextField
            ...
            InputProps={{
              startAdornment: <InputAdornment position="start">{fieldInfo.icon}</InputAdornment>,
            }}
          >
            {states.map((state) => (
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          ...
          {!isEditMode ? (
            <Button
              ...
              startIcon={<EditIcon />}
              onClick={handleEdit}
              sx={{ bgcolor: "white", color: "primary.main", "&:hover": { bgcolor: alpha(theme.palette.common.white, 0.9) } }}
            >
              Edit
            </Button>
          ) : (
            <Stack direction="row" spacing={1}>
              ...
              <Button
                ...
                sx={{ borderColor: "white", color: "white", "&:hover": { bgcolor: alpha(theme.palette.common.white, 0.1) } }}
              >
                Cancel
              </Button>
            </Stack>
