...
async function resolveCurrentEmail() {
  ...
  try {
    const lsEmail = localStorage.getItem("email") || localStorage.getItem("userEmail") || "";
  ...
  return (
    <Box p={2}>
      ...
      <Row className="mb-3">
        ...
        <Col md={4}>
          <TextField fullWidth required type="date" InputLabelProps={{ shrink: true }} label="DOB" name="dob" value={formData.dob} onChange={handleChange} />
        </Col>
        <Col md={4}>
          <TextField fullWidth required label="Phone 1" name="phone1" value={formData.phone1} onChange={handleChange} />
        </Col>
      </Row>
      ...
      <Row className="mb-3">
        <Col md={6}>
          <TextField fullWidth label="Phone 2" name="phone2" value={formData.phone2} onChange={handleChange} />
        </Col>
        <Col md={6}>
          <TextField fullWidth label="Order Expires" type="datetime-local" InputLabelProps={{ shrink: true }} name="orderExpires" value={formData.orderExpires || ""} onChange={handleChange} />
        </Col>
      </Row>
      ...
      <Row className="mb-3">
        <Col md={4}>
          <FormControl>
            ...
            <RadioGroup row name="observed" value={formData.observed} onChange={handleChange}>
      ...
      <Row className="mb-3">
        ...
        <Col md={6}>
          <TextField fullWidth label="Address 2" name="address2" value={formData.address2} onChange={handleChange} />
        </Col>
      </Row>

      <Row className="mb-4">
        <Col md={4}>
          <TextField fullWidth required label="City" name="city" value={formData.city} onChange={handleChange} />
        </Col>
        <Col md={4}>
        ...
        <Col md={4}>
          <TextField fullWidth required label="Zip Code" name="zip" value={formData.zip} onChange={handleChange} />
        </Col>
      </Row>
      ...
      <Box display="flex" justifyContent="space-between">
        ...
        <Box>
          {formData.sendLink ? (
            <Button variant="contained" onClick={handSubmitLink} disabled={!validateRequiredFields()}>
              Submit
            </Button>
          ) : (
            <Button variant="contained" onClick={handleContinue} disabled={!validateRequiredFields()}>
              Continue
            </Button>
          )}
        </Box>
