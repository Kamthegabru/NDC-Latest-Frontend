...
function ActiveDriver() {
  ...
  const handleEditOpen = () => {
    setEditedDriver({
      ...
      licenseNumber: selectedDriver.government_id
    });
    setEditOpen(true);
    setErrors({});
    handleMenuClose();
  ...
  const handleSaveEdit = async () => {
    ...
    setLoading(true);
    try {
      // Here you would call your update driver function
  ...
  const handleDeleteDriver = async () => {
    setLoading(true);
    try {
      // Here you would call your delete driver function
          ...
          <TableBody>
            {drivers.map((driver, index) => (
              ...
              >
                ...
                {!isTablet && (
                  <TableCell>
                    <Typography variant="body2">{normalizePhoneNumber(driver.phone)}</Typography>
                  </TableCell>
                )}
                  ...
                  <Grid item xs={12} sm={6}>
                    <Stack spacing={0.5}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, fontFamily: 'monospace' }}>
                        {formatLicenseNumber(selectedDriver?.government_id)}
                      </Typography>
                    </Stack>
                  </Grid>
